...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/user/api/blogs/**", "/user/api/public/**").permitAll()
                .antMatchers("/uploads/**", "/ws/**").permitAll()
                .antMatchers("/user/api/events").permitAll()
                .antMatchers("/user/api/competitions").permitAll()
                ...
                .antMatchers("/user/api/courses/*/lessons/*/code-server", "/user/api/courses/*/lessons/*/submit-code").authenticated()
                .antMatchers("/user/api/events/*", "/user/api/events/*/register", "/user/api/events/*/registration-status", "/user/api/events/*/cancel-registration").authenticated()
                .antMatchers("/user/api/posts", "/user/api/posts/**", "/user/api/posts/*/like", "/user/api/posts/*/comments", "/user/api/posts/comments/*", "/user/api/posts/*/comments/*").authenticated()
                .antMatchers("/user/api/enrollments").authenticated()
                .antMatchers("/user/api/settings/profile-picture", "/user/api/settings/**").authenticated()
                .antMatchers("/user/api/user/payment-history", "/user/api/users/search", "/user/api/chat/users/search", "/user/api/chat/conversations").authenticated()
                .antMatchers("/user/api/friendships/suggestions/random", "/user/api/friendships", "/user/api/friendships/**").authenticated()
                .antMatchers("/user/api/chat/conversations/*/messages", "/user/api/chat/messages/*", "/user/api/chat/conversations/*/files").authenticated()
                .antMatchers("/user/api/stories/**").authenticated()
                .antMatchers("/user/api/competitions/*", "/user/api/competitions/*/register", "/user/api/competitions/*/start", "/user/api/competitions/*/problems/*", "/user/api/competitions/submissions/*", "/user/api/competitions/*/scoreboard").authenticated()

                // Authenticated
                .antMatchers("/user/api/courses/**/enroll", "/user/api/courses/**/create-paypal-order", "/user/api/courses/**/learn").authenticated()
                .antMatchers("/user/api/payment/paypal/success").authenticated()
                .antMatchers("/user/api/auth/oauth/**").authenticated()
                .antMatchers("/user/api/courses/*/check-enrollment").authenticated()
                .antMatchers("/user/api/user/**", "/user/api/users/**").authenticated()
                .antMatchers("/user/api/auth/logout", "/user/api/auth/check", "/user/api/auth/me").authenticated()
