...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/auth/login", "/auth/register", "/passkeys/check-registration").permitAll()
                .antMatchers("/courses/paypal/success", "/courses/paypal/cancel").permitAll()
                .antMatchers("/courses", "/courses/{courseId}").permitAll()
                .antMatchers("/favicon.ico").permitAll()
                .antMatchers("/", "/blogs/**", "/public/**").permitAll()
                .antMatchers("/uploads/**", "/ws/**").permitAll()
                .antMatchers("/events", "/competitions").permitAll()
                ...
                .antMatchers("/events/*", "/events/*/register", "/events/*/registration-status", "/events/*/cancel-registration").authenticated()
                .antMatchers("/posts", "/posts/**", "/posts/*/like", "/posts/*/comments", "/posts/comments/*", "/posts/*/comments/*").authenticated()
                .antMatchers("/enrollments").authenticated()
                .antMatchers("/settings/profile-picture", "/settings/**").authenticated()
                .antMatchers("/user/payment-history", "/users/search", "/chat/users/search", "/chat/conversations", "/users/**").authenticated()
                .antMatchers("/friendships/**").authenticated()
                .antMatchers("/chat/conversations/*/messages", "/chat/messages/*", "/chat/conversations/*/files").authenticated()
